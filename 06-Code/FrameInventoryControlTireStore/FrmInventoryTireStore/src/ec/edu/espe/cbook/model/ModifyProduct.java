...
public class ModifyProduct extends javax.swing.JFrame {
    ...
    public ModifyProduct() {
        ...
        tabla.addColumn("PRICE");tabla.addColumn("CONDITION");
    ...
    MongoCursor<Document> consulta = Inventory.find().iterator();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(answer == JOptionPane.OK_OPTION){
            Upload upload = new Upload(this,true, Inventory, idUpload);
    ...
    public void view(){
        ...
        MongoCursor<Document> consult = Inventory.find().iterator();
    ...
    public boolean Delete(String id){
        DeleteResult answer = Inventory.deleteOne(new Document("_id", new ObjectId(id)));
